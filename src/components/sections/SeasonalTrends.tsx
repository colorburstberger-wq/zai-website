...
const SEASONS: SeasonalPalette[] = [
  ...
  },
  {
    ...
    colors: [
      { name: "Saffron Sun", hex: "#F2A93B", mood: "Bright" },
      { name: "Mustard Field", hex: "#D9A441", mood: "Bold" },
      { name: "Terracotta Glow", hex: "#E0623A", mood: "Warm" },
      { name: "Paprika Spice", hex: "#B23A1B", mood: "Spicy" },
    ],
  ...
  },
  {
    ...
    colors: [
      { name: "Clay Hut", hex: "#B65C3F", mood: "Rustic" },
      { name: "Cinnamon Stick", hex: "#A0522D", mood: "Spicy" },
      { name: "Sand Dune", hex: "#D4B896", mood: "Earthy" },
      { name: "Olive Branch", hex: "#7B7D4F", mood: "Grounded" },
    ],
